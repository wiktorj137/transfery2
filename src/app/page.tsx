        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Krakow Transfer</h1>
                <p className="text-xs text-gray-500 hidden sm:block">Airport & City Transfers</p>
              </div>
            </Link>
            <a 
              href="tel:+48123456789"
              className="group flex items-center gap-2 border-2 border-blue-600 text-blue-600 px-5 py-2.5 rounded-xl font-semibold hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm hover:shadow-md"
            >
              <Phone className="w-4 h-4 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-sm sm:text-base font-bold">+48 123 456 789</span>
            </a>
          </div>
        </div>
      </header>
