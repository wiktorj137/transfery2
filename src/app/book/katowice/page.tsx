...
const katowiceDestination = {
  name: 'Katowice - Silesian Capital',
  shortName: 'Katowice',
  ...
  description: 'Explore the dynamic capital of the Silesian region, a city transformed from industrial heritage to a modern cultural hub. Discover cutting-edge architecture, world-class concert halls, and a vibrant urban atmosphere.',
  highlights: [
    'International Congress Centre - architectural marvel',
    'Silesian Museum - largest in Poland',
    'Nikiszowiec historic miners district',
    'Spodek arena - iconic flying saucer building',
    'Vibrant street art and urban culture',
    'Gateway to Industrial Monuments Route'
  ],
  whatToExpect: [
    'Visit the stunning Silesian Museum complex',
    'See the iconic Spodek concert hall',
    'Explore Nikiszowiec red-brick architecture',
    'Walk through modern city center with parks',
    'Discover industrial heritage sites',
    'Experience vibrant cafes and restaurants'
  ],
  tips: [
    'Silesian Museum ticket includes mine tower views',
    'Nikiszowiec district perfect for photography',
    'Many attractions within walking distance',
    'Try traditional Silesian cuisine',
    'Public transport is efficient and modern',
    'Great base for exploring Silesian region'
  ],
...
export default function KatowiceTransferPage() {
  ...
  useEffect(() => {
    const prefillData = {
      ...
      dropoff: katowiceDestination.name,
      dropoffCoords: katowiceDestination.coordinates
    };
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src={katowiceDestination.image}
            alt={katowiceDestination.name}
            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-xl px-4 py-3 flex items-center gap-2 shadow-lg">
                  ...
                  <span className="text-white font-medium">{katowiceDestination.location}</span>
                </div>
                <div className="bg-white/20 backdrop-blur-md border border-white/30 rounded-xl px-4 py-3 flex items-center gap-2 shadow-lg">
                  <Clock className="w-5 h-5 text-white" />
                  <span className="text-white font-medium">{katowiceDestination.distance} • {katowiceDestination.duration}</span>
                </div>
                <div className="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl px-4 py-3 flex items-center gap-2 shadow-lg">
                  ...
                  <span className="text-white font-bold">From {katowiceDestination.price} PLN</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-8 border border-gray-100">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  {katowiceDestination.description}
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-sm p-8 border border-blue-100">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {katowiceDestination.highlights.map((highlight, index) => (
                    <div 
                      key={index} 
              ...
              <div className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 p-8 border border-gray-100">
                ...
                <div className="space-y-3">
                  {katowiceDestination.whatToExpect.map((item, index) => (
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl shadow-sm p-8 border border-amber-200">
                ...
                <div className="space-y-3">
                  {katowiceDestination.tips.map((tip, index) => (
